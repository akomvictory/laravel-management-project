        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="/reservation" method="POST" enctype="multipart/form-data"> 
           @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Room Title</label>
                    <input type="text" required name="room_title" class="form-control" id="exampleInputTitle" placeholder="Enter room title">
                  </div>


                  <div class="form-group">
                    <label for="exampleInputEmail1">Room Price</label>
                    <input type="text" required name="room_price" class="form-control" id="exampleInputTitle" placeholder="Enter room title">
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Accomodation Number</label>
                    <input type="text" required name="room_number" class="form-control" id="exampleInputTitle" placeholder="Enter room title">
                  </div>
            ...
            <div class="card-body pad">
              <div class="mb-3">
                <textarea class="textarea" required name="room_description" placeholder="Place some text here"
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file"  type=".jpg,.jpeg.png,.tif" required name="photo_two" class="custom-file-input" id="exampleInputFile">
                        <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                      </div>
                      <div class="input-group-append">
                        <span class="input-group-text" id="">Upload</span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" type=".jpg,.jpeg.png,.tif" required name="photo_three" class="custom-file-input" id="exampleInputFile">
                        <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                      </div>
                      <div class="input-group-append">
                        <span class="input-group-text" id="">Upload</span>
