          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
               ...
               @foreach($all_accomodation as $all_accomodation)
      
                    <tr role="row" class="odd">
                      <td class="sorting_1">{{$all_accomodation->id}}</td>
                      <td>{{$all_accomodation->room_title}}</td>
                      <td>{{$all_accomodation->room_price}}</td>
                      <td></td>
                      <td>{{$all_accomodation->room_number}}</td>
                      <td>
                      <a href="/reservation/{{$all_accomodation->id}}/edit" class="btn btn-primary btn-sm">Edit</a>
                          
                      <form action="/reservation/{{$all_accomodation->id}}" method="POST">
                      @csrf
                      @method("DELETE")
